...
train_label=y_data[0:463715]
test_data=x_data[0:51630]
test_label=y_data[0:51630]
...
with tf.Session() as sess:
    ...
    for epoch in range(500):
        avg_cost=0
        c, _ = sess.run([cost, train], feed_dict={X: train_data, Y: train_label, keep_prob: 0.7})
        avg_cost += c
